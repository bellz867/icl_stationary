...
void DepthEstimatorICL::initialize(Eigen::Vector3f uInit, float zminInit, float zmaxInit, float tauInit)
{
    uk = uInit;
    zmin = zminInit;
    zmax = zmaxInit;
...
Eigen::Vector3f DepthEstimatorICL::update(Eigen::Vector3f uc, Eigen::Vector3f ukc, Eigen::Matrix3f Rkc, Eigen::Vector3f v, Eigen::Vector3f pkc, ros::Time t, float dt, bool patternLost)
{
  float kzk = 20.0;
